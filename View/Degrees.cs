...
namespace projekt1.View {
    static class Degrees {
        public static void ConvertFromF() {
            double input = Model.TypeChecker.WriteAndReadDoubleLine("Hur många grader i F°: ");
        ...
        public static void ConvertFromC() {
            double input = Model.TypeChecker.WriteAndReadDoubleLine("Hur många grader i C°: ");
        ...
        public static void ConvertFromK() {
            double input = Model.TypeChecker.WriteAndReadDoubleLine("Hur många grader i K°: ");
